...
![104845950-621d2b80-591b-11eb-89fc-b1db8472faa2](https://user-images.githubusercontent.com/77096463/104947414-15128580-59ff-11eb-961a-5617d4977a46.png){: width="50%" height="50%"0}

사용량만큼 요금을 부과하는 클라우드 특성상, 미리 카드 정보를 받아두어 혹여 Free Tier로 요금 발생 시 카드로 결제되게끔 설정해두었다. 

![image-20210117123104537](2021-01-17-aws_environment.assets/104845961-7103de00-591b-11eb-93b5-8312a2d34d9e.png){: width="50%" height="50%"0}

Free Tier로 이용할 계획이므로 기본 플랜 (무료)을 선택한다. 그러면 계정 생성은 모두 완료된다! 

![image-20210117123457847](2021-01-17-aws_environment.assets/104845982-8f69d980-591b-11eb-9142-e69b713ff051.png){: width="50%" height="50%"0}

처음 회원가입한 계정은 AWS root 계정으로 간주되어, 로그인 시 '루트 사용자'로 로그인하면 된다.

![image-20210117123706769](2021-01-17-aws_environment.assets/104845989-9bee3200-591b-11eb-97ac-4a6fcd510469.png){: width="50%" height="50%"0}
...
2. 사용자 세부 정보 설정
   ...
   ![image-20210117124316647](2021-01-17-aws_environment.assets/104845995-a4466d00-591b-11eb-9c6c-24f19887ceee.png){: width="50%" height="50%"0}

3. 권한 설정 : 기본 정책 직접 연결 -> 'AdministratorAccess' 선택

4. 태그 : 태그 미설정 -> 사용자 생성 완료 (ID : 641489732843 ) -> IAM user 로 로그인 가능

![image-20210117155351917](2021-01-17-aws_environment.assets/104846017-be804b00-591b-11eb-8c11-ea2f9dfcfd18.png)
...
![image-20210117160513966](2021-01-17-aws_environment.assets/104846031-cd66fd80-591b-11eb-809b-0d9254ccb706.png){: width="50%" height="50%"0}

3. [가상 MFA 디바이스] 유형 선택 -> 위 화면에서 QR 코드 표시 선택한 후, Google OTP 앱으로 QR코드 스캔하여 MFA 코드 입력하기 -> MFA 할당 완료

![image-20210117231146919](2021-01-17-aws_environment.assets/104846126-5bdb7f00-591c-11eb-944d-444d16384498.png){: width="50%" height="50%"0}
...
![image-20210117161629656](2021-01-17-aws_environment.assets/104846051-e7084500-591b-11eb-9388-891c6a341bfd.png){: width="50%" height="50%"0}
...
![image-20210117161841273](2021-01-17-aws_environment.assets/104846063-f4253400-591b-11eb-9259-ab7fe2e7966d.png){: width="50%" height="50%"0}
...
![image-20210117162638872](2021-01-17-aws_environment.assets/104846072-ff785f80-591b-11eb-9cc1-dcf7c5773abd.png){: width="50%" height="50%"0}
...
![image-20210117163840077](2021-01-17-aws_environment.assets/104846081-0b642180-591c-11eb-8dda-d54ce2da2b69.png){: width="50%" height="50%"0}
...
![image-20210117163944008](2021-01-17-aws_environment.assets/104846083-11f29900-591c-11eb-9076-f1812b4ee633.png){: width="50%" height="50%"0}
...
3. [Private subnet] 의 라우팅 테이블
   ...
   ![image-20210117194018597](2021-01-17-aws_environment.assets/104846087-1b7c0100-591c-11eb-839d-b7461b31642b.png){: width="50%" height="50%"0}
...
![image-20210117194503764](2021-01-17-aws_environment.assets/104846094-26369600-591c-11eb-8cd5-a32de6f8fc53.png){: width="50%" height="50%"0}
...
![image-20210117201526234](2021-01-17-aws_environment.assets/104846100-30f12b00-591c-11eb-85f2-56df7962178e.png){: width="50%" height="50%"0}

2. SSH 접속을 위해 22번 포트를 열어 놓는다. (규칙 추가 -> 2번째 유형으로 추가)

![image-20210117201851680](2021-01-17-aws_environment.assets/104846105-377fa280-591c-11eb-84ca-bd7dc4e3709f.png){: width="50%" height="50%"0}
...
![image-20210117230301290](2021-01-17-aws_environment.assets/104846112-4403fb00-591c-11eb-8c56-a568a71f13de.png){: width="50%" height="50%"0}
...
![image-20210117230902117](2021-01-17-aws_environment.assets/104846114-4cf4cc80-591c-11eb-8ccc-8267fd105fc8.png){: width="50%" height="50%"0}
